...
def collate_vlembed(inputs_patches, inputs_embeds, seg_data, visual_segdata, vis_special_token=None, attention_mask=None, num_patches=14, max_len=0):
    ...
    seg_data = seg_data.to(torch.float32)
...
class AlfredUnimodelForConditionalGeneration(T5ForConditionalGeneration):
    """
    ...
    def __init__(self, config):
        super(AlfredUnimodelForConditionalGeneration, self).__init__(config)
