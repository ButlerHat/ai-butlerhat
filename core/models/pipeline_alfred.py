...
class AlfredPipeline(Pipeline):
    """
    Pipeline to do inference with Alfred.
    """
    ...
    def _sanitize_parameters(self, 
        image_size: int = 224, 
        ocr_url: Optional[str] = 'http://nginx_alfred:80/fd/ppocrv3',
...
if __name__ == "__main__":
    ...
    from core.models.alfred_unimodel import AlfredUnimodelForConditionalGeneration
    ...
    t_start = time.time()
    prediction = alfred({"image":image, "instruction":instruction})
    t_end = time.time()
