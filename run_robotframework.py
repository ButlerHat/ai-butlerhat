...
from core.trainers import DataCollator, AlfredWandbCallback
from core.models import AlfredDualForConditionalGeneration, AlfredUnimodelForConditionalGeneration, AlfredConfig, AlfredTokenizer
from config.hf_training_args import CustomTrainingArguments


MODEL_CLASSES = {
    'AlfredDual': (AlfredConfig, AlfredDualForConditionalGeneration, AlfredTokenizer),
    'AlfredUnimodel': (AlfredConfig, AlfredUnimodelForConditionalGeneration, AlfredTokenizer),
}
...
def main():
    ...
    if "wandb" in training_args.report_to:
        ...
        os.environ["WANDB_PROJECT"]="alfred"
   ...
   # Get datasets
    ...
    def compute_metrics(eval_pred: EvalPrediction):
        ...
        # iou metric
        if isinstance(tokenizer, AlfredTokenizer):
            # Get bbox if 
    ...
    trainer = Trainer(
        ...
        callbacks=[AlfredWandbCallback()] if "wandb" in training_args.report_to else None,
    )
